      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link href="/faq" className="hover:text-indigo-400 transition-colors duration-200 inline-block">সাধারণ জিজ্ঞাসা</Link>
              </li>
              <li>
                <Link href="/return-policy" className="hover:text-indigo-400 transition-colors duration-200 inline-block">রিটার্ন নীতি</Link>
              </li>
              <li>
                <Link href="/delivery-info" className="hover:text-indigo-400 transition-colors duration-200 inline-block">ডেলিভারির তথ্য</Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-indigo-400 transition-colors duration-200 inline-block">যোগাযোগ করুন</Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              {s.email && (
                <li className="flex items-center space-x-3 group">
                  ...
                  <a href={`mailto:${s.email}`} className="hover:text-indigo-400 transition-colors duration-200">
                    {s.email}
                  </a>
                </li>
              )}
              {s.phone && (
                <li className="flex items-center space-x-3 group">
                  ...
                  <a href={`tel:${s.phoneEnglish || s.phone}`} className="hover:text-indigo-400 transition-colors duration-200">
                    {s.phone}
                  </a>
                </li>
              )}
        ...
        <div className="border-t border-gray-800 pt-8 mt-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center md:text-left">
            ...
            <div className="flex justify-center space-x-6 text-sm text-gray-500">
              <Link href="/privacy-policy" className="hover:text-indigo-400 transition-colors duration-200">গোপনীয়তা নীতি</Link>
              <Link href="/terms-of-service" className="hover:text-indigo-400 transition-colors duration-200">পরিষেবার শর্তাবলী</Link>
            </div>
